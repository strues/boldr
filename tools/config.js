...
const buildOutputPath = pathResolve(appRootPath, 'boldrCMS');
...
module.exports = {
  ...
  server: {
    ...
    port: envVars.SSR_PORT
      ? parseInt(envVars.SSR_PORT, 10)
      : 3000,
  ...
  development: {
    ...
    // it run on?
    clientDevServerPort: envVars.WPDS_PORT
      ? parseInt(envVars.WPDS_PORT, 10)
      : 3001,
  ...
  paths: {
    ...
    // Shared src
    commonSrc: pathResolve(appRootPath, './src/common'),
    // The service worker.
