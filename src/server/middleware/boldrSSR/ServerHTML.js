...
function ServerHTML(props) {
  ...
  const bodyElements = removeNil([
    ...
    ifElse(process.env.BUILD_FLAG_IS_DEV && config('bundles.client.devDlls.enabled'))(
      () => scriptTag(
        `${config('bundles.client.webPath')}${config('bundles.client.devDlls.name')}.js?t=${Date.now()}`,
      ),
    ),
