...
const getProp = (obj, propName) => (obj.get ? obj.get(propName) : obj[propName]); // eslint-disable-line
...
export class Notifications extends PureComponent {
  ...
  render() {
    ...
    const classes = ['boldrui-notification__container', className || null].join(' ').split();
