...
describe('<NavbarMenu />', () => {
  ...
  it('should render a div with .boldrui-navbar__menu', () => {
    ...
    expect(component.contains(<nav className="boldrui-navbar__menu">My Nav</nav>)).toBe(true);
  });

  it('should render a div with .boldrui-navbar__menu and modifiers', () => {
    const component = shallow(
      <NavbarMenu isActive>
        <span>Any Content</span>
      </NavbarMenu>,
    );
    expect(component.hasClass('boldrui-navbar__menu')).toBe(true);
    expect(component.hasClass('is-active')).toBe(true);
  });

  it('should render a div with .boldrui-navbar__menu, modifiers and custom classNames', () => {
    const component = shallow(
  ...
  it('should render a div with .boldrui-navbar__menu and custom classNames', () => {
    const component = shallow(
