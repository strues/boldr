...
describe('(React Component) Collapsible', () => {
  ...
  it('should propagate the passed "className" if passed.', () => {
    const wrapper = shallow(<Collapsible className="test">TEST</Collapsible>);

    expect(wrapper.html()).toContain('test');
  });

  it('should render the "title" if passed.', () => {
    const wrapper = shallow(<Collapsible title="test">TEST</Collapsible>);
  ...
  it('should render an toggler anchor.', () => {
    const wrapper = shallow(<Collapsible>Foo test</Collapsible>);
  ...
  it('should render a "delete" icon in case the "onDelete" prop was passed.', () => {
    ...
    const wrapper = shallow(<Collapsible onDelete={onDelete}>Foo test</Collapsible>);
