    ...
    return (
      ...
      >
        <div className="boldr-editor__image-modal-header">
          {uploadEnabled &&
            ...
            >
              Upload
              <span
                className={classNames('boldr-editor__image-modal-header-label', {
        ...
        {uploadHighlighted
          ? <div onClick={this.fileUploadClick}>
              <div
                ...
                className={classNames('boldr-editor__image-modal-upload-option', {
                  'boldr-editor__image-modal-upload-option-highlighted': dragEnter,
                })}
              >
                <label htmlFor="file" className="boldr-editor__image-modal-upload-option-label">
        ...
        <span className="boldr-editor__image-modal-btn-section">
          ...
          <button className="boldr-editor__image-modal-btn" onClick={doCollapse}>
            Cancel
          </button>
        </span>
        {showImageLoading
