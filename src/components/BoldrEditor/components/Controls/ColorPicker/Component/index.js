...
class LayoutComponent extends Component {
  ...
  renderModal: Function = (): Object => {
    ...
    return (
      <div
        className={classNames('boldr-editor__colorpicker-modal', popupClassName)}
        onClick={stopPropagation}
      >
        <span className="boldr-editor__colorpicker-modal-header">
          <span
            className={classNames('boldr-editor__colorpicker-modal-style-label', {
              'boldr-editor__colorpicker-modal-style-label-active': currentStyle === 'color',
            })}
          ...
          <span
            className={classNames('boldr-editor__colorpicker-modal-style-label', {
              'boldr-editor__colorpicker-modal-style-label-active': currentStyle === 'bgcolor',
            })}
        ...
        <span className="boldr-editor__colorpicker-modal-options">
          {colors.map((color, index) =>
            ...
            >
              <span style={{ backgroundColor: color }} className="boldr-editor__colorpicker-cube" />
            </Option>,
          )}
        </span>
      </div>
