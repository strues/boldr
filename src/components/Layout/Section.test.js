...
describe('Section', () => {
  ...
  it('should render a div with .section', () => {
    ...
    expect(container.contains(<div className="boldrui-section">My Section</div>)).toBe(true);
  });

  it('should render a section with .boldrui-section and modifiers', () => {
    const containerLarge = shallow(<Section isSize="large" />);
    expect(containerLarge.hasClass('boldrui-section')).toBe(true);
    expect(containerLarge.hasClass('is-large')).toBe(true);

    const containerMedium = shallow(<Section isSize="medium" />);
    expect(containerMedium.hasClass('boldrui-section')).toBe(true);
    expect(containerMedium.hasClass('is-medium')).toBe(true);

    const containerFail = shallow(<Section isSize="fail" />);
    expect(containerFail.hasClass('boldrui-section')).toBe(true);
    expect(containerFail.hasClass('is-fail')).toBe(false);
  });

  it('should render a section with .boldrui-section, modifiers and custom classNames', () => {
    const container = shallow(<Section isSize="medium" className="custom loader" />);
    expect(container.hasClass('boldrui-section')).toBe(true);
  ...
  it('should render a section with .boldrui-section with custom classNames', () => {
