...
describe('Controlled Checkbox', () => {
  ...
  it('className', () => {
    const checkbox = TestUtils.renderIntoDocument(<Checkbox className="customClassName" />);
  ...
  it('prefix', () => {
    ...
    expect(
      TestUtils.findRenderedDOMComponentWithClass.bind(TestUtils, checkbox, 'custom-checkbox'),
    ).not.toThrow();
    expect(
  ...
  it('with label', () => {
    const checkbox = TestUtils.renderIntoDocument(<Checkbox>Checkbox</Checkbox>);
