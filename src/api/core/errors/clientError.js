...
class NotFound extends HttpError {
  constructor() {
    super('The server monkey might have misplaced the requested resource.', 'NotFound', 404);
  }
}
...
/**
 * @class AccountNotVerifiedError
 * @param {string} message the error message.
 * @param {string} name the name of the error
 * @param {number} code the error code.
 */
class AccountNotVerifiedError extends HttpError {
  constructor() {
    super('This account has not been confirmed. Please check your email for a verification link.',
      'AccountNotVerifiedError', 401);
  }
}

export { BadRequest, Unauthorized, Forbidden, NotFound, MethodNotAllowed, Conflict, AccountNotVerifiedError };
