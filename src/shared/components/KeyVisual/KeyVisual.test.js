...
describe('(React Component) Keyvisual', () => {
  it('should add the passed "className" prop to the rendered node if passed.', () => {
    const rernderAsset = props => (
      <img src="http://placehold.it/300x300" {...props} />
    );
    const wrapper = shallow(
      <KeyVisual className="test" asset={rernderAsset}>My contents</KeyVisual>,
    );
  ...
  it('should render the image.', () => {
    ...
    const wrapper = shallow(
      <KeyVisual asset={rernderAsset}>My contents</KeyVisual>,
    );
  ...
  it('should propagate props to the wrapper element.', () => {
    ...
    const wrapper = mount(
      <KeyVisual onClick={handler} asset={rernderAsset}>My contents</KeyVisual>,
    );
