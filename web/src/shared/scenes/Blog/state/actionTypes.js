...
export const UPDATE_ARTICLE_REQUEST =
  '@boldr/admin/posts/UPDATE_ARTICLE_REQUEST';
export const UPDATE_ARTICLE_SUCCESS =
  '@boldr/admin/posts/UPDATE_ARTICLE_SUCCESS';
export const UPDATE_ARTICLE_FAILURE =
  '@boldr/admin/posts/UPDATE_ARTICLE_FAILURE';

export const CREATE_ARTICLE_REQUEST =
  '@boldr/admin/posts/CREATE_ARTICLE_REQUEST';
export const CREATE_ARTICLE_SUCCESS =
  '@boldr/admin/posts/CREATE_ARTICLE_SUCCESS';
export const CREATE_ARTICLE_FAILURE =
  '@boldr/admin/posts/CREATE_ARTICLE_FAILURE';

export const DELETE_ARTICLE_FAILURE =
  '@boldr/admin/posts/DELETE_ARTICLE_FAILURE';
export const DELETE_ARTICLE_REQUEST =
  '@boldr/admin/posts/DELETE_ARTICLE_REQUEST';
export const DELETE_ARTICLE_SUCCESS =
  '@boldr/admin/posts/DELETE_ARTICLE_SUCCESS';
