  ...
  getHashtagComponent = () => {
    ...
    return class HashtagComponent extends Component {
      ...
      render() {
        ...
        return (
          <a href={text} className={classNames('boldr-editor__hashtag-link', className)}>
            {children}
          </a>
        );
      }
...
const getHashtagDecorator = config => new Hashtag(config).hashDecorator();

export default getHashtagDecorator;
