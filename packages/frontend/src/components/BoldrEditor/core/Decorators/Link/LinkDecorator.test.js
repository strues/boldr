...
import { Entity, convertFromHTML, AtomicBlockUtils, ContentState, EditorState } from 'draft-js';

import getLinkDecorator from './LinkDecorator';
...
describe('LinkDecorator test suite', () => {
  ...
  it('should have state initialized correctly', () => {
    ...
    expect(control.state().showPopOver).toBeFalsy();
  });
