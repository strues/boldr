...
*     style of a character before focus is returned.
 *
 * @param {EditorState} editorState  the draft-js editor state object
 * @returns {Object}  the inlineStyle object
 */
 ...
 * }
 * @param  {[type]} editorState [description]
 * @param  {[type]} entityKey   [description]
 * @return {[type]}             [description]
 */
...
/**
 * Set style.
 * @param {[type]} styleType [description]
 * @param {[type]} styleKey  [description]
...
export function toggleCustomInlineStyle(
  ...
  let nextEditorState = EditorState.push(editorState, nextContentState, 'changeinline-style');
 ...
 * @param {[type]} stylePrefix [description]
