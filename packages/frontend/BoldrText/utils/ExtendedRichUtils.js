...
import { getCurrentlySelectedBlock } from './block';
...
const ExtendedRichUtils = Object.assign({}, RichUtils, {
  ...
  toggleAlignment(editorState, alignment) {
    const { content, currentBlock, hasAtomicBlock, target } = getCurrentlySelectedBlock(
      editorState,
    );
    ...
    const alignmentToSet = !!blockData && keyName === alignment ? undefined : alignment;
