/* eslint-disable return-assign, consistent-return, no-param-reassign */
// @flow
...
import type { OptionFontFamilies } from './options';
...
// $FlowIssue
const styleToHTML = ({ fontFamilies }: OptionFontFamilies) => (style: Object) => {
