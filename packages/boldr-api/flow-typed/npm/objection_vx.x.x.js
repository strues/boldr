/**
 * Flowtype definitions for objection
...
declare module 'objection' {
    ...
    declare type RelationMappings = {
        [relationName: string]: RelationMapping
    };
    declare interface Relation {}
    declare interface RelationJoin {
        from: string | string[],
            to: string | string[],
            through?: RelationThrough
    }
    declare interface RelationThrough {
        from: string | string[],
            to: string | string[],
            modelClass?: string | typeof Model,
            extra?: string[]
    }
    declare interface RelationMapping {
        relation: Relation,
    ...
    declare interface EagerAlgorithm {}
    declare interface EagerOptions {
        minimize?: boolean,
            separator?: string,
            aliases?: string[]
    }
     ...
     */
    declare type FieldExpression = string;

    /**
     *
     * @see  http://vincit.github.io/objection.js/#relationexpression
     */
    declare type RelationExpression = string;
    declare type FilterFunction =<T>(queryBuilder: QueryBuilder<T>) => void;
    declare type FilterExpression = {
        [namedFilter: string]: FilterFunction
    };
    declare interface RelationExpressionMethod {
        (relationExpression: RelationExpression): QueryBuilder<T >
    }
    declare interface TraverserFunction {
    ...
    declare type Ids = Id[];
    declare type IdOrIds = Id | Ids;
    declare type RelationOptions = {
        alias: boolean | string
    };
    declare interface JoinRelation {
        (relationName: string, opt?: RelationOptions): QueryBuilder<T >
    }
    declare type JsonObjectOrFieldExpression = Object | Object[] | FieldExpression;
    declare interface WhereJson<T>{
        (fieldExpression: FieldExpression, jsonObjectOrFieldExpression: JsonObjectOrFieldExpression): QueryBuilder<T >
    }
    declare interface WhereFieldExpression<T>{
        (fieldExpression: FieldExpression): QueryBuilder<T >
    }
    declare interface WhereJsonExpression<T>{
        (fieldExpression: FieldExpression, keys: string | string[]): QueryBuilder<T >
    }
    declare interface WhereJsonField<T>{
        (fieldExpression: FieldExpression, operator: string, value: boolean | number | string | null): QueryBuilder<T >
    }
    declare interface ModifyEager<T1>{
        (relationExpression: string | RelationExpression, modifier: (builder: QueryBuilder<T2>) => void): QueryBuilder<T1 >
    }
    declare interface BluebirdMapper<T, Result>{
        (item: T, index: number): Result
    }
    declare interface NodeStyleCallback {
        (err: any, result?: any): void
    }
    declare type Filters<T>= {
     ...
     */
    declare interface ModelClass<T>{
        new(): T,
        tableName: string,
    ...
    declare class Model {
        ...
        HasManyRelation: Relation;
        ManyToManyRelation: Relation;
        JoinEagerAlgorithm: () => any;
        WhereInEagerAlgorithm: () => any;
        query<T>(this: {
            new(): T
        }, trx?: Transaction): QueryBuilder<T>;
        knex(knex?: knex): knex;
        formatter(): any;
        knexQuery<T>(this: {
            new(): T
        }): QueryBuilder<T>;
        bindKnex<T>(this: T, knex: knex): T;
        bindTransaction<T>(this: T, transaction: Transaction): T;
        extend<S, T>(this: T, subclass: S): S & T;
        fromJson<T>(this: T, json: Object, opt?: ModelOptions): T;
        fromDatabaseJson<T>(this: T, row: Object): T;
        omitImpl(f: (obj: Object, prop: string) => void): void;
        loadRelated<T>(
            this: {
                new(): T
        ...
        $loadRelated<T>(
            expression: RelationExpression,
            filters?: Filters<T>): QueryBuilderSingle<this>;
     ...
     */
    declare type QueryBuilder<T>= {} & QueryBuilderBase & Promise


    /**
     * QueryBuilder with one expected result
     */
    declare type QueryBuilderSingle<T>= {} & QueryBuilderBase & Promise
    ...
    declare type QueryBuilderBase<T>= {
        ...
        relate<M>(ids: IdOrIds | Partial<M>| Partial<M>[]): this,
        unrelate(): this,
        forUpdate(): this,
        forShare(): this,
        ...
        execute(): Promise<any>,
        map<T,
        Result>(mapper: BluebirdMapper<T, Result>): Promise<Result[]>,
    ...
    declare interface transaction {
        start(knexOrModel: knex | ModelClass<any>): Promise<Transaction>,
            (modelClass: MC, callback: (boundModelClass: MC) => Promise<T>): Promise<T>,
            (modelClass1: MC1, modelClass2: MC2, callback: (boundModel1Class: MC1, boundModel2Class: MC2) => Promise<T>): Promise<T>,
            (modelClass1: MC1, modelClass2: MC2, modelClass3: MC3, callback: (
                boundModel1Class: MC1,
                boundModel2Class: MC2,
                boundModel3Class: MC3) => Promise<T>): Promise<T>,
            (modelClass1: MC1, modelClass2: MC2, modelClass3: MC3, modelClass4: MC4, callback: (
                boundModel1Class: MC1,
                boundModel2Class: MC2,
                boundModel3Class: MC3,
                boundModel4Class: MC4) => Promise<T>): Promise<T >
    }
    declare var transaction: transaction;
    declare interface Transaction {
        commit(): void,
            rollback(): void
    }
    declare type Raw = knex.Raw;
    ...
    */
    declare type Value = string |
        ...
        Raw |
        null;
    declare type ColumnName<T>= string | Raw | QueryBuilder<T>;
    declare type TableName<T>= string | Raw | QueryBuilder<T>;
    declare interface QueryInterface<T>{
        select: Select<T>,
        as: As<T>,
        columns: Select<T>,
        column: Select<T>,
    ...
    declare interface As<T>{
        (columnName: string): QueryBuilder<T >
    }
    declare type Select<T>= {} & ColumnNameQueryBuilder
    ...
    declare type Distinct<T>= {} & ColumnNameQueryBuilder

    declare interface Join<T>{
        (raw: Raw): QueryBuilder<T>,
        (tableName: string, columns: {
            [key: string]: string | Raw
        }): QueryBuilder<T>,
        (tableName: string, callback: Function): QueryBuilder<T>,
        (tableName: TableName<T1>, raw: Raw): QueryBuilder<T>,
        (tableName: TableName<T1>, column1: string, column2: string): QueryBuilder<T>,
        (tableName: TableName<T1>, column1: string, raw: Raw): QueryBuilder<T>,
        (tableName: TableName<T1>, column1: string, operator: string, column2: string): QueryBuilder<T >
    }
    declare interface JoinClause {
        on(raw: Raw): JoinClause,
            ...
            using(column: string | string[] | Raw | {
                [key: string]: string | Raw
            }): JoinClause,
            type(type: string): JoinClause
    }
    declare interface JoinRaw<T>{
        (tableName: string, binding?: Value): QueryBuilder<T >
    }
    declare type Where<T>= {
        (raw: Raw): QueryBuilder<T>,
        (callback: (queryBuilder: QueryBuilder<T1>) => any): QueryBuilder<T>,
        ...
        (columnName: string | Raw, operator: string, query: QueryBuilder<T1>): QueryBuilder<T >
    } & WhereRaw & WhereWrapped & WhereNull

    declare type WhereRaw<T>= {
        (condition: boolean): QueryBuilder<T >
    } & RawQueryBuilder

    declare interface WhereWrapped<T>{
        (callback: Function): QueryBuilder<T >
    }
    declare interface WhereNull<T>{
        (columnName: string): QueryBuilder<T>,
        (columnName: string): QueryBuilder<T >
    }
    declare interface WhereIn<T>{
        (columnName: string, values: Value[]): QueryBuilder<T>,
        (columnName: string, callback: Function): QueryBuilder<T>,
        (columnName: string, query: QueryBuilder<T1>): QueryBuilder<T>,
        (columnName: string, values: Value[]): QueryBuilder<T >
    }
    declare interface WhereBetween<T>{
        (columnName: string, range: [Value, Value]): QueryBuilder<T >
    }
    declare interface WhereExists<T>{
        (callback: Function): QueryBuilder<T>,
        (query: QueryBuilder<T1>): QueryBuilder<T >
    }
    declare type GroupBy<T>= {} & RawQueryBuilder & ColumnNameQueryBuilder

    declare interface OrderBy<T>{
        (columnName: string, direction?: string): QueryBuilder<T >
    }
    declare interface Union<T>{
    ...
    declare type Having<T>= {
        (tableName: string, column1: string, operator: string, column2: string): QueryBuilder<T >
    } & RawQueryBuilder & WhereWrapped

    declare interface ColumnNameQueryBuilder<T>{
        (...columnNames: ColumnName<T>[]): QueryBuilder<T>,
        (columnNames: ColumnName<T>[]): QueryBuilder<T >
    }
    declare interface RawQueryBuilder<T>{
