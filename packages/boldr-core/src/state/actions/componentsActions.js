/**
 * @module boldr-core/lib/state/actions/componentsActions
 */
export const COMPONENT_ADD_STATE = 'BOLDR_CORE.COMPONENT_ADD_STATE';
export const COMPONENT_MERGE_STATE = 'BOLDR_CORE.COMPONENT_MERGE_STATE';
export const COMPONENT_REMOVE_STATE = 'BOLDR_CORE.COMPONENT_REMOVE_STATE';
