/**
 * @module boldr-core/lib/state/actions/collectionsActions
 */
import invariant from 'invariant';

export const COLLECTION_ADD_OR_REPLACE = 'BOLDR_CORE.COLLECTION_ADD_OR_REPLACE';
export const COLLECTION_REMOVE = 'BOLDR_CORE.COLLECTION_REMOVE';
export const COLLECTION_MUTATE = 'BOLDR_CORE.COLLECTION_MUTATE';
