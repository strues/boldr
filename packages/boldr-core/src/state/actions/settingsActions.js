...
export const REQUEST_SETTINGS = 'BOLDR_CORE.REQUEST_SETTINGS';
export const REQUEST_KO = 'BOLDR_CORE.REQUEST_SETTINGS_KO';
export const REQUEST_OK = 'BOLDR_CORE.REQUEST_SETTINGS_OK';
