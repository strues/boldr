...
export const makeSelectAuth = () => createSelector(selectProfile, accountState => accountState.auth);

export const makeSelectUser = () => createSelector(selectProfile, accountState => accountState.user);
