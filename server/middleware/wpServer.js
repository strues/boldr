// @NOTE https://github.com/60frames/webpack-hot-server-middleware
const path = require('path');
const requireFromString = require('require-from-string');
const MultiCompiler = require('webpack/lib/MultiCompiler');
const sourceMapSupport = require('source-map-support');
const debug = require('debug')('boldr:server:wpServerMW');
 ...
 */
function wpServerMiddleware(multiCompiler, options) {
  debug('Using servermiddleware');
...
module.exports = wpServerMiddleware;
